    ...
    <nav class="main-header !h-[3.75rem]" aria-label="Global">
        <div class="main-header-container ps-[0.725rem] pe-[1rem] ">
            ...
            <div class="flex justify-center items-center gap-4 ">
                ...
                <a target="_blank" href="{{route('customlogviewer',['OMM-459'])}}">gggggggg</a>
...
{{--                </div>--}}
                ...
                <div class="header-element py-[1rem] md:px-[0.65rem] px-2 notifications-dropdown header-notification hs-dropdown ti-dropdown !hidden md:!block [--placement:bottom-left]">
                    <button id="dropdown-notification" type="button"
                        ...
                        <span class="flex absolute h-5 w-5 -top-[0.25rem] end-0  -me-[0.6rem]">
              <span
                 style="display: none"   id="notificationcircles"  class="animate-slow-ping absolute inline-flex -top-[2px] -start-[2px] h-full w-full rounded-full bg-secondary/40 opacity-75">

              </span>
              <span
                      style="display: none"       class="relative inline-flex justify-center items-center rounded-full  h-[14.7px] w-[14px] bg-secondary text-[0.625rem] text-white"
                      id="notification-icon-badge">

              </span>
            </span>
                    </button>
                    <div id="notificationcontainer" class="main-header-dropdown !-mt-3 !p-0 hs-dropdown-menu ti-dropdown-menu bg-white !w-[22rem] border-0 border-defaultborder hidden !m-0"
...
{{--                            <p class="mb-0 text-[1.0625rem] text-defaulttextcolor font-semibold dark:text-[#8c9097] dark:text-white/50">შეტყობინებები</p>--}}
                            <button hx-get="{{route('mark.as.read')}}" hx-target="#main-content" hx-indicator="#indicator" type="button" class="ti-btn ti-btn-light ti-btn-wave mt-1">ყველა ცვლილებების ჩატვირთვა</button>
...
{{--                                            class="ti ti-headset text-[1.125rem] me-2 opacity-[0.7]"></i>Support</a></li>--}}
                            <li>
                                ...
                                <button class="w-full ti-dropdown-item !text-[0.8125rem] !p-[0.65rem] !gap-x-0 !inline-flex"><i
                                            class="ti ti-logout text-[1.125rem] me-2 opacity-[0.7]"></i>გასვლა</button>
                                </form>
                            </li>
                        </ul>
                    </div>
