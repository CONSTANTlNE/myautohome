            ...
            <div class="box-body ">
               <div class="table-responsive">
                  <table class="text-center table whitespace-nowrap min-w-full">
                     ...
                     <tr class="border-b border-primary/10 text-center">
                        <th style="text-align: center!important"  class="text-center">დასახელება</th>
                        <th style="text-align: center!important;width: 20px!important;white-space: normal" class="text-center">სახელის რედაქტირება</th>
                        <th style="text-align: center!important;width: 20px!important;white-space: normal" class="text-center">ფერის ცვლილება</th>
                     </tr>
                     </thead>
                     <tbody>
                     @foreach($statuses as $index => $status)
                        ...
                        <tr class="border-b border-primary/10 text-center">
                           ...
                           <td style="width: 15px!important">
                              <div class="hstack flex justify-center gap-3 text-[.9375rem]">
                                 {{--                              <a aria-label="anchor" href="javascript:void(0);" class="ti-btn ti-btn-sm ti-btn-info !rounded-full"></a>--}}
                                 <a href="javascript:void(0);" class="hs-dropdown-toggle ti-btn ti-btn-sm ti-btn-info !rounded-full" data-hs-overlay="#status{{$index}}">
                           ...
                           <td>
                              ...
                              <div id="colorupdate{{$index}}" class="hs-overlay hidden ti-modal">
                                 <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out">
                                    <div class="ti-modal-content">
                                       <div class="ti-modal-header">
                                          <h6 class="modal-title text-[1rem] font-semibold" >სტატუსის ფერი</h6>
                                          <button type="button" class="hs-dropdown-toggle !text-[1rem] !font-semibold !text-defaulttextcolor" data-hs-overlay="#colorupdate{{$index}}">
                                             <span class="sr-only">Close</span>
                                             <i class="ri-close-line"></i>
                                          </button>
                                       </div>
                                       ...
                                       <div class="ti-modal-footer">
                                          <button
                                                  type="submit"
                                                  class="hs-dropdown-toggle ti-btn  ti-btn-secondary-full align-middle"
                                                  data-hs-overlay="#colorupdate{{$index}}">
                                             შეცვლა
                                          </button>
