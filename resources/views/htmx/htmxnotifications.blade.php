    ...
    <li style="background-color: #1a1c1e!important" class="ti-dropdown-item dropdown-item ">
        <div class="flex items-start justify-center">
            ...
            <div class="grow flex items-center justify-between">
                <div style="width: 100%">
                    <p style="cursor:pointer" class="newnotifications mb-0 text-defaulttextcolor dark:text-[#8c9097] dark:text-white/50 text-[0.8125rem] font-semibold">
                        <a hx-indicator="#indicator" hx-get="{{route('edit.htmx', $notification->application->id)}}" hx-target="#edittarget"  data-hs-overlay="#editmodal" href="javascript:void(0);" class="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium block">{{$notification->type}} {{$notification->application->number}}</a>
</p>
...
@endforeach
<script>
   let newnotifications=document.querySelectorAll(".newnotifications")
