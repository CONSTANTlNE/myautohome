            ...
            <form action="{{route('status.create')}}" method="post">
                ...
                <div class="box-body">
                    ...
                    <a href="javascript:void(0);" class="hs-dropdown-toggle ti-btn ti-btn-primary-full"
                       data-hs-overlay="#color">ფერის არჩევა
                    </a>
                    <div id="color" class="hs-overlay hidden ti-modal">
                        <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out">
                            <div class="ti-modal-content">
                                <div class="ti-modal-header">
                                    <h6 class="modal-title text-[1rem] font-semibold" id="mail-ComposeLabel">სტატუსის
                                        ფერი</h6>
                                    <button type="button"
                                            class="hs-dropdown-toggle !text-[1rem] !font-semibold !text-defaulttextcolor"
                                            data-hs-overlay="#color">
        ...
        <div class="box">
            ...
            <form action="{{route('source.create')}}" method="post">
                ...
                <div class="box-body">
                    ...
                    <button
                            type="button"
                            hx-post="{{route('source.create')}}"
                            hx-target="#main-content"
                            hx-indicator="#indicator"
                            class="ti-btn ti-btn-primary-full" >დამატება</button>
                </div>
            </form>
            <div class="box-footer hidden border-t-0">
                <!-- Prism Code -->
                ...
                <div class="table-responsive">
                    <table class="text-center table whitespace-nowrap min-w-full">
                        ...
                        <tr class="border-b border-primary/10 text-center">
                            ...
                            <th style="text-align: center!important;width: 20px!important" class="text-center">
                                მოქმედება
                            </th>
                        </tr>
                        </thead>
                        ...
                        @foreach($companies as $index => $company)
                            <tr class="border-b border-primary/10 text-center">
                                <td style="white-space:normal;max-width: 100px; word-wrap: break-word; overflow-wrap: break-word;"
                                    class="text-center">{{$company->name}}</td>
                                <td style="width: 15px!important">
                                    <div class="hstack flex justify-center gap-3 text-[.9375rem]">
                                        ...
                                        <a href="javascript:void(0);"
                                           ...
                                           data-hs-overlay="#todo-compose{{$index}}"><i class="ri-edit-line"></i>
                                        </a>
                                                ...
                                                <div class="ti-modal-content">
                                                    <div class="ti-modal-header">
                                                        <h6 class="modal-title text-[1rem] font-semibold"
                                                            id="company{{$index}}">კომპანიის რედაქტირება</h6>
                                                        <button type="button"
                                                                class="hs-dropdown-toggle !text-[1rem] !font-semibold !text-defaulttextcolor"
                ...
                <div class="table-responsive">
                    <table class="text-center table whitespace-nowrap min-w-full">
                        ...
                        @foreach($products as $index => $product)
                            <tr class="border-b border-primary/10 text-center">
                                <td style="white-space:normal;max-width: 100px; word-wrap: break-word; overflow-wrap: break-word;"
                                    class="text-center">{{$product->name}}</td>
                                <td style="width: 15px!important">
                                    <div class="hstack flex justify-center gap-3 text-[.9375rem]">
                                        {{--                              <a aria-label="anchor" href="javascript:void(0);" class="ti-btn ti-btn-sm ti-btn-info !rounded-full"></a>--}}
                                        <a href="javascript:void(0);"
                                           class="hs-dropdown-toggle ti-btn ti-btn-sm ti-btn-info !rounded-full"
                                           data-hs-overlay="#product{{$index}}"><i class="ri-edit-line"></i>
                                        </a>
                            ...
                            <tr class="border-b border-primary/10 text-center">
                                ...
                                <td style="width: 15px!important">
                                    <div class="hstack flex justify-center gap-3 text-[.9375rem]">
                                        ...
                                        <a href="javascript:void(0);"
                                           class="hs-dropdown-toggle ti-btn ti-btn-sm ti-btn-info !rounded-full"
                                           data-hs-overlay="#status{{$indexstatus}}">
                                            <i class="ri-edit-line"></i>
                                        </a>
                                        <form>
                                            @csrf
                                            <div id="status{{$indexstatus}}" class="hs-overlay hidden ti-modal">
                                                <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out">
                                                    <div class="ti-modal-content">
                                                        <div class="ti-modal-header">
                                                            <h6 class="modal-title text-[1rem] font-semibold">კომპანიის
                                ...
                                <td>
                                    <div class="hstack flex justify-center gap-3 text-[.9375rem]">
                                        <a href="javascript:void(0);"
                                           class="hs-dropdown-toggle ti-btn ti-btn-sm ti-btn-info !rounded-full"
                                           data-hs-overlay="#colorupdate{{$indexstatus}}">
                                            <i class="ri-edit-line"></i>
                                        </a>
                                        <form  method="post">
                                            @csrf
                                            <input type="hidden" name="id" value="{{$status->id}}">
                                            <div id="colorupdate{{$indexstatus}}" class="hs-overlay hidden ti-modal">
                                                <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out">
                                                    <div class="ti-modal-content">
                                                        <div class="ti-modal-header">
                ...
                <div class="table-responsive">
                    <table class="text-center table whitespace-nowrap min-w-full">
                        ...
                        @foreach($sources as $index => $source)
                            <tr class="border-b border-primary/10 text-center">
                                <td style="white-space:normal;max-width: 100px; word-wrap: break-word; overflow-wrap: break-word;"
                                    class="text-center">{{$source->name}}</td>
                                <td style="width: 15px!important">
                                    <div class="hstack flex justify-center gap-3 text-[.9375rem]">
                                        {{--                              <a aria-label="anchor" href="javascript:void(0);" class="ti-btn ti-btn-sm ti-btn-info !rounded-full"></a>--}}
                                        <a href="javascript:void(0);"
                                           class="hs-dropdown-toggle ti-btn ti-btn-sm ti-btn-info !rounded-full"
                                           data-hs-overlay="#source{{$index}}"><i class="ri-edit-line"></i>
                                        </a>
                                        <div id="source{{$index}}" class="hs-overlay hidden ti-modal">
                                            <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out">
                                                <div class="ti-modal-content">
                                                    <div class="ti-modal-header">
                                                        <h6 class="modal-title text-[1rem] font-semibold"
                                                            id="source{{$index}}">კომპანიის რედაქტირება</h6>
                                                        <button type="button"
                                                                class="hs-dropdown-toggle !text-[1rem] !font-semibold !text-defaulttextcolor"
