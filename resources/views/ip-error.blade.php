...
{{--                                <p class="mb-0 opacity-[0.7]">We are sorry for the inconvenience,The page you are trying--}}
{{--                                    to access has been removed or never been existed.</p>--}}
{{--                            </div>--}}
{{--                        </div>--}}
{{--                        <a href="index.html"--}}
{{--                           class="ti-btn bg-primary text-white font-semibold dark:border-defaultborder/10"><i--}}
